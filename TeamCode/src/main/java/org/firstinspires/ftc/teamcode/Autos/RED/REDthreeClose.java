...
public class REDthreeClose extends OpMode {
    ...
    private final Pose parkingPose = new Pose(RED_AUTO_CONSTANTS.CLOSE_PARK_X, RED_AUTO_CONSTANTS.CLOSE_PARK_Y, Math.toRadians(RED_AUTO_CONSTANTS.CLOSE_PARK_HEADING));
