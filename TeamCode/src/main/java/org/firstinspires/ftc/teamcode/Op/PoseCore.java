...
public class PoseCore {
    ...
    public static double BLUE_LINE_CLOSE_X = 70;
    public static double BLUE_LINE_CLOSE_Y = 77.75;
    ...
    public static double RED_LINE_CLOSE_X = 72.75;
    public static double RED_LINE_CLOSE_Y = 77.75;
